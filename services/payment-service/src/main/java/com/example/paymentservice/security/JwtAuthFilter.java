...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        boolean isFullPaymentList = "GET".equalsIgnoreCase(method) && path.endsWith("/payments");
        if (isFullPaymentList && !"ADMIN".equalsIgnoreCase(tokenRole)) {
            response.sendError(HttpServletResponse.SC_FORBIDDEN, "Admin role required to list all payments");
            return;
        }
